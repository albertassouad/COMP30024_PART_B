...
class Board:
	...
	def new_board():
		...
		whites = [[1,0,7], [1,1,7],   [1,3,7], [1,4,1],   [1,6,7], [1,7,7],
         			[1,0,6], [1,1,6],   [1,3,0], [1,4,6],   [1,6,6], [1,7,6]]

		blacks = [[1,0,1], [1,1,1],   [1,3,2], [1,4,3],   [1,6,1], [1,7,1],
...
# for c in children:
# 	squares_to_string(c)
# 	print(minimax(Board(c), 1, True))




# minimax(board, depth = 5, True)
